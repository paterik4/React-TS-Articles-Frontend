...
export const CreateArticle: React.FC<CreateArticleProps> = () => {
    ...
    const validationSchema = Yup.object().shape({
        ...
        body: Yup.string()
            ...
            .max(200, 'Article body must not exceed 200 characters'),
    ...
    const CustomInputComponent = (props: any) => (
        <textarea className="resize-y max-h-52 min-h-32 my-custom-input" {...props} />
    );
    ...
    return (
        <div className="py-10">
            ...
            >
                {({ errors, touched }) => (
                    <Form>
                        <div className="grid grid-rows-5 grid-flow-col gap-4 auto-rows-max py-10 px-40">
                            ...
                            <div className="form-check">
                                ...
                                <div role="group" aria-labelledby="checkbox-group" className="form-check2">
                                {tags ? (
                                    tags.map((item: any, i: number) => (
                                        <div key={i} className="checkBoxText">
                                            <Field type="checkbox" name="tagList" value={item.tag} />
